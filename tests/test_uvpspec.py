...
class TestUVPSpec:
    ...
    def test_stats_array(self, vanilla_uvp_with_beam: uvpspec.UVPSpec, tmp_path: Path):
    ...
    def test_compute_scalar(
        self, vanilla_uvp: uvpspec.UVPSpec, vanilla_uvp_with_beam: uvpspec.UVPSpec
    ):
        uvp = copy.deepcopy(vanilla_uvp_with_beam)
    ...
    def test_set_cosmology(
        self, vanilla_uvp_with_beam: uvpspec.UVPSpec, beam_nf_dipole
    ):
        uvp = copy.deepcopy(vanilla_uvp_with_beam)
