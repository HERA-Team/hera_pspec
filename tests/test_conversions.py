...
def test_distances(cosmo_h100):
    ...
    np.testing.assert_almost_equal(
        cosmo_h100.DC(10.0, little_h=False), 6499.708111027144
    )
    np.testing.assert_almost_equal(cosmo_h100.DM(10.0), 6510.2536925709637)
    np.testing.assert_almost_equal(cosmo_h100.DA(10.0), 591.84124477917851)
    np.testing.assert_almost_equal(cosmo_h100.dRperp_dtheta(10.0), 6510.2536925709637)
    np.testing.assert_almost_equal(cosmo_h100.dRpara_df(10.0), 1.2487605057418872e-05)
    np.testing.assert_almost_equal(
        cosmo_h100.dRpara_df(10.0, ghz=True), 12487.605057418872
    )
    np.testing.assert_almost_equal(cosmo_h100.X2Y(10.0), 529.26719942209002)
...
def test_little_h():
    ...
    np.testing.assert_almost_equal(C.DC(10.0, little_h=True), 6499.708111027144)
    np.testing.assert_almost_equal(
        C.DC(10.0, little_h=False), 6499.708111027144 * 100.0 / 25.12
    )
    np.testing.assert_almost_equal(C.DM(10.0, little_h=True), 6510.2536925709637)
    np.testing.assert_almost_equal(C.DA(10.0, little_h=True), 591.84124477917851)
    np.testing.assert_almost_equal(
