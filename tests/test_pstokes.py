...
def pstokes_setup():
    ...
    uvd1.read_miriad(dset1)
    setattr(uvd1, "vis_units", "Jy")
    uvd2 = pyuvdata.UVData()
    uvd2.read_miriad(dset2)
    setattr(uvd2, "vis_units", "Jy")
    return SimpleNamespace(uvd1=uvd1, uvd2=uvd2)


def test_combine_pol(pstokes_setup):
    uvd1 = copy.deepcopy(pstokes_setup.uvd1)
    uvd2 = copy.deepcopy(pstokes_setup.uvd2)
...
def test_combine_pol_arrays(pstokes_setup):
    uvd1 = copy.deepcopy(pstokes_setup.uvd1)
    uvd2 = copy.deepcopy(pstokes_setup.uvd2)
...
def test_construct_pstokes(pstokes_setup):
    uvd1 = pstokes_setup.uvd1
    uvd2 = pstokes_setup.uvd2
...
def test_filter_dset_on_stokes_pol(pstokes_setup):
    dsets = [pstokes_setup.uvd1, pstokes_setup.uvd2]
    ...
    dsets = [pstokes_setup.uvd2, pstokes_setup.uvd1]
