...
class Test_DataSet(unittest.TestCase):
    ...
    def test_AiryBeam(self):
        ...
        nt.assert_true(np.isclose(tval_l, Om_p[0]))


        scalar = airy.compute_pspec_scalar(lower_freq, upper_freq, num_freqs, pol='pI', num_steps=2000)

        scalar_large_Nsteps = airy.compute_pspec_scalar(lower_freq, upper_freq, num_freqs, num_steps=5000)
