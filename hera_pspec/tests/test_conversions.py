...
class Test_Cosmo(unittest.TestCase):
    def setUp(self):
        self.C = conversions.Cosmo_Conversions(
    ...
    def test_distances(self):
        ...
        np.testing.assert_almost_equal(
            self.C.DC(10.0, little_h=False), 6499.708111027144
        )
        ...
        np.testing.assert_almost_equal(
            self.C.dRpara_df(10.0, ghz=True), 12487.605057418872
        )
    ...
    def test_little_h(self):
        ...
        np.testing.assert_almost_equal(self.C.E(10.0), 20.450997530682947)
        np.testing.assert_almost_equal(
            self.C.DC(10.0, little_h=True), 6499.708111027144
        )
        np.testing.assert_almost_equal(
            self.C.DC(10.0, little_h=False), 6499.708111027144 * 100.0 / 25.12
        )
        np.testing.assert_almost_equal(
            self.C.DM(10.0, little_h=True), 6510.2536925709637
        )
        np.testing.assert_almost_equal(
            self.C.DA(10.0, little_h=True), 591.84124477917851
        )
        np.testing.assert_almost_equal(
            self.C.dRperp_dtheta(10.0, little_h=True), 6510.2536925709637
        )
        np.testing.assert_almost_equal(
            self.C.dRpara_df(10.0, little_h=True), 1.2487605057418872e-05
        )
        np.testing.assert_almost_equal(
            self.C.dRpara_df(10.0, ghz=True, little_h=True), 12487.605057418872
        )
        np.testing.assert_almost_equal(
            self.C.X2Y(10.0, little_h=True), 529.26719942209002
        )
